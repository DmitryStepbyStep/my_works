...
namespace SeleniumAdvanced
{
    class CreateNewPage
    {
        ...
        public CreateNewPage CreateNewProduct() //создание нового продукта
        {
            productNamefield.SendKeys("Charlotte");
            categoryfield.Click();
            ...
            supplierfield.Click();
            {
                ...
                dropdown.FindElement(By.XPath("//option[. = 'Exotic Liquids']")).Click();
            }
            supplierfield.Click();
            ...
            actions
                ...
                .SendKeys(unitsinstockfield, "163")
